      ...
      <div class="container mx-auto max-w-[76.25rem] px-4">
        ...
        <div class="grid grid-cols-1 gap-y-2 md:grid-cols-3">
          <div class="relative min-h-[360px] xl:min-h-[500px]">
            <img src="https://catprotection.com.au/wp-content/uploads/2023/10/male-cat.jpg" alt="" class="object-cover h-full w-full">
          ...
          <div class="relative min-h-[360px] xl:min-h-[500px]">
            <img src="https://catprotection.com.au/wp-content/uploads/2023/10/female-cat.jpg" alt="" class="object-cover h-full w-full">
            <div class="absolute w-full inset-0 bg-gradient-to-t from-black/80 to-transparent via-black/20 flex items-end">
              <div class="p-5 text-center w-full">
          ...
          <div class="relative min-h-[360px] xl:min-h-[500px]">
            <img src="https://catprotection.com.au/wp-content/uploads/2023/10/pregnant-cat4.jpg" alt="" class="object-cover h-full w-full">
            <div class="absolute w-full inset-0 bg-gradient-to-t from-black/80 to-transparent via-black/20 flex items-end">
